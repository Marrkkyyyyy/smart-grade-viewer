...
class CustomStudentProfileTextfield extends StatelessWidget {
  const CustomStudentProfileTextfield({
    Key? key,
    required this.icon,
  ...
  final StudentEditProfileController controller;
  final bool isPassword;
  final bool passwordVisibility;
  final String? Function(String?) valid;
  @override
  Widget build(BuildContext context) {
    return GetBuilder<StudentEditProfileController>(builder: (controller) {
      return Container(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(20),
              borderSide: const BorderSide(color: AppColor.orange, width: 1.2),
            ),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(20),
              borderSide: const BorderSide(color: AppColor.orange, width: .8),
            ),
