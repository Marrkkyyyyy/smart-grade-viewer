...
class StudentEditProfileController extends GetxController {
  ...
  editProfile() async {
    ...
    var response = await studentRequest.editProfile(
        image,
        studentID!,
  ...
  changePassword(String currentPassword, String newPassword) async {
    statusRequestChangePass = StatusRequest.loading;
    update();
    EasyLoading.show(status: "Loading...", dismissOnTap: true);
  ...
  void onInit() {
    ...
    emailAddressController = TextEditingController(text: emailAddress);
